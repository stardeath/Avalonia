...
namespace Avalonia.Themes.Hevadea
{
    public enum HevadeaThemeMode
    {
        Light,
        Dark,
    }
    ...
    /// </summary>
    public class HevadeaTheme : AvaloniaObject, IStyle, IResourceProvider
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HevadeaTheme"/> class.
        /// </summary>
        /// <param name="baseUri">The base URL for the XAML context.</param>
        public HevadeaTheme(Uri baseUri)
        {
            _baseUri = baseUri;
            InitStyles(baseUri);
        }
        ...
        public HevadeaTheme(IServiceProvider serviceProvider)
        {
        ...
        public static readonly StyledProperty<HevadeaThemeMode> ModeProperty =
            AvaloniaProperty.Register<HevadeaTheme, HevadeaThemeMode>(nameof(Mode));

        public static readonly StyledProperty<DensityStyle> DensityStyleProperty =
            AvaloniaProperty.Register<HevadeaTheme, DensityStyle>(nameof(DensityStyle));

        /// <summary>
        /// Gets or sets the mode of the fluent theme (light, dark).
        /// </summary>
        public HevadeaThemeMode Mode
        {
        ...
        public IStyle Loaded
        {
            get
            {
                if (_loaded == null)
                {
                    ...
                    if (Mode == HevadeaThemeMode.Light)
                    {
                        _loaded = new Styles() { _sharedStyles , _fluentLight[0], _fluentLight[1] };
                    }
                    else if (Mode == HevadeaThemeMode.Dark)
                    {
        ...
        private void InitStyles(Uri baseUri)
        {
            _sharedStyles = new Styles
            {
                ...
                {
                    Source = new Uri("avares://Avalonia.Themes.Hevadea/Accents/AccentColors.xaml")
                },
                new StyleInclude(baseUri)
                {
                    Source = new Uri("avares://Avalonia.Themes.Hevadea/Accents/Base.xaml")
                },
                new StyleInclude(baseUri)
                {
                    Source = new Uri("avares://Avalonia.Themes.Hevadea/Controls/HevadeaControls.xaml")
                }
            };
            ...
            _fluentLight = new Styles
            {
                new StyleInclude(baseUri)
                {
                    Source = new Uri("avares://Avalonia.Themes.Hevadea/Accents/BaseLight.xaml")
                },
                new StyleInclude(baseUri)
                {
                    Source = new Uri("avares://Avalonia.Themes.Hevadea/Accents/HevadeaControlResourcesLight.xaml")
                }
            };
            ...
            _fluentDark = new Styles
            {
                new StyleInclude(baseUri)
                {
                    Source = new Uri("avares://Avalonia.Themes.Hevadea/Accents/BaseDark.xaml")
                },
                new StyleInclude(baseUri)
                {
                    Source = new Uri("avares://Avalonia.Themes.Hevadea/Accents/HevadeaControlResourcesDark.xaml")
                }
            };
            ...
            _densityStyles = new Styles
            {
                new StyleInclude(baseUri)
                {
                    Source = new Uri("avares://Avalonia.Themes.Hevadea/DensityStyles/Compact.xaml")
                }
            };
        }
    }
